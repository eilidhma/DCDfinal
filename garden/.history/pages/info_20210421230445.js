...
const Info = () => {
  ...
  return (
        ...
        <div className="info" >
          ...
          <div data-aos="flip-up"><Description text="Feeling of accomplishment"/>
          <div data-aos="slide-right"><SmallDescription text="The sense of pride and accomplishment that comes from eating that first tomato or snap pea from your backyard will amaze you. It doesn’t just have to be that first ever crop either – that feeling often extends year after year."/></
