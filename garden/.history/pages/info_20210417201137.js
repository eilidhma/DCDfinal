  ...
  return (
    <html>
      <body>
        ...
        <MainButton onClick={HandleChange} text={<><VscArrowRight></VscArrowRight>Wellness Benefits</>}/>
        <MainButton onClick={HandleChange} text={<>Wellness Benefits<VscArrowRight></VscArrowRight></>}/>
        </div>
      </body>
    </html>
  )
