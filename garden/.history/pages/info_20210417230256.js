...
export default function Home() {
  ...
  return (
        ...
        <div className="info" >
          ...
          {/* START OF Directory */}
          {mainstate === 0 && <div className="infoContent">
          <MainImg src="couple.png" width="30%"/>
            <div className="ButtonCont">
              <ButtonUI text="Sustainability" onClick={Sust,Title}/>
              <ButtonUI text="Wellness Benefits" onClick={Well,Title}/>
              <ButtonUI text="Saving the Bees" onClick={{Bees,Title}}/> 
            </div>
