...
export default function Home() {
  ...
  return (
        ...
        <div className="infoContent">
          ...
          <SmallDescription text={<>"Through a 4-questions questionnaire, "</><strong></strong>  <"will be able to find perfect recommendations for plants that you can grow at home based on your climate, interest, and time available to take care of your new friend."/>}/>
        </div>
        </div>
