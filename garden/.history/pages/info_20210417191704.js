    ...
    <html>
      <body>
        <div className="info" >
          ...
          <div className="BlankBox">
            <PlantDetailsLarge src="globeicon.png" text="Strawberries may contain up to 40 different pesticides" width="70"/>
            <PlantDetailsLarge src="globeicon.png" text="Celery may contain more than 60 different pesticides" width="70"/>
            <PlantDetailsLarge src="globeicon.png" text="Cucumber skin may contain more than 80 different pesticides" width="70"/>
          </div>
