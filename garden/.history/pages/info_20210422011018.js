...
const Info = () => {
  ...
  const [vegstate, setVeg] = useState(veg.lettuce)
  const [vegimg, setVeg] = useState(veg.lettuce)
  const [vegtitle, setVeg] = useState(veg.lettuce)
  const [vegfact, setVeg] = useState(veg.lettuce)
  ...
  const HandleVeg = () => {
    if(vegstate === veg.lettuce){
      setVeg(veg.tomato)
    }
    if(vegstate === veg.tomato){
      setVeg(veg.potato)
    }
    if(vegstate === veg.potato){
      setVeg(veg.apple)
    }
    if(vegstate === veg.apple){
      setVeg(veg.banana)
    }
    if(vegstate === veg.banana){
      setVeg(veg.lettuce)
    }
  }
