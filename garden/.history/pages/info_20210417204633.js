      ...
      <body>
        <div className="info" >
          ...
          <div className="infoContent">
            ...
            <div className="BlankBox">
              <PlantDetailsLarge src="flowericon.png" text="Reduce the use of gasoline-power yard tools" />
              <PlantDetailsLarge src="flowericon.png" text="Reduce water consumption" />
              <PlantDetailsLarge src="flowericon.png" text="Improve your energy efficiency"/>
            </div>  
          </div>
          {/* END OF BEES */}
