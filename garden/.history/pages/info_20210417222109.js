...
export default function Home() {
  ...
  return (
        ...
        {mainstate === 1 && <MainButton onClick={HandleChange} text={<>Wellness Benefits<VscArrowRight/></>}/>}
        {mainstate === 2 && <MainButton onClick={HandleChange} text={<><VscArrowLeft/>Sustainability</>}/>}
        {mainstate === 2 && <MainButton onClick={HandleChange} text={<>Saving the Bees<VscArrowRight/></>}/>}
        {mainstate === 3 && <MainButton onClick={HandleChange} text={<><VscArrowLeft/>Wellness Benefits</>}/>}
