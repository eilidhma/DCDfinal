      ...
      <body>
        <div className="info" >
          ...
          <div className="infoContent">
            ...
            <SmallDescription text="When you take the time to prepare, plant, weed, water, and harvest your own garden, you are getting sunshine, fresh air, and physical activity. All that digging, planting and weeding burns calories and strengthens your heart. says UNC Health internal medicine physician Robert Hutchins, MD, MPH. “It’s hard work to garden, and it provides some cardiovascular benefit."/>
          </div>
          {/* END OF WELLNESS */}
