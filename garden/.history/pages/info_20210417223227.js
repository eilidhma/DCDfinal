  ...
  return (
        ...
        <div className="info" >
          ...
          <div className="infoContent">
            ...
            <ButtonUI text="Sustainability" routeTo="/info" onClick={Sust}/>
            <ButtonUI text="Wellness Benefits" routeTo="/quiz" onClick={Well}/>
            <ButtonUI text="Saving the Bees" routeTo="/quiz" onClick={Bees}/>
          </div>
