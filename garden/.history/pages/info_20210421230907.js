  ...
  return (
        ...
        <div className="info" >
          ...
          {mainstate === 3 && <div className="infoContent">
            ...
            <div data-aos="zoom-in"><SmallDescription text="Since 2010, the United States has suffered a loss of 40% of its local honeybees. Native bee species are dying off too, with many of them categorized as either endangered or significantly declining. "/>
