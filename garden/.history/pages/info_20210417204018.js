      ...
      <body>
        <div className="info" >
          ...
          <div className="infoContent">
            ...
            <SmallDescription text="When you take the time to prepare, plant, weed, water, and harvest your own garden, you are getting sunshine, fresh air, and physical activity. "/>
          </div>
          {/* END OF WELLNESS */}
