...
export default function Quiz() {
  ...
  const [button1, setButton1State] = useState(questions.first.Q);
  const [button2, setButton2State] = useState(questions.second.Q);
  const [button3, setButton3State] = useState(questions.third.Q);
  ...
  return (
    <div className="quiz">
      ...
      <ButtonUI text="Next Question" routeTo="/quiz" onClick={HandleChange}/>
    </div>
  )
}