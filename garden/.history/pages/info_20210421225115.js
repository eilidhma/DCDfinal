  ...
  return (
        ...
        <div className="info" >
          ...
          {mainstate === 1 && <div className="infoContent">
            ...
            <div data-aos="slide-right"><SmallDescription text="Supermarket fruits and vegetables contain less nutrients than they used to. But one thing they aren’t lacking on is pesticides."/>
