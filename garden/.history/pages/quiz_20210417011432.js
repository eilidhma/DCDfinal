...
export default function Quiz() {
  ...
  const HandleChange = () =>{
    ...
    if(question === questions.third.Q){
      ...
      if(buttonstate === 1){
        reactLocalStorage.set('Good in',{'Good in':'pots/planters'})
      }
      if(buttonstate === 2){
        reactLocalStorage.set('Goog in',{'Good in':'ground'})
      }
    ...
    if(question === questions.fourth.Q){
      ...
      if(buttonstate === 1){
        reactLocalStorage.set('category',{'Category':'Vegetables/Fruits/Herbs'})
      }
      if(buttonstate === 2){
        reactLocalStorage.set('category',{'Category':'Flowers/Plants'})
      }
