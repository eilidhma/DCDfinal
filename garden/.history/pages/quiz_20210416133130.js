...
export default function Quiz() {
  const [buttonstate, setButton1State] = useState(false);
  ...
  return (
    <div className="quiz">
      ...
      <ButtonUI 
        text="Temperate" 
        onClick={Button1} 
        background = {button1state ? "#367A17" : "#FFFFFF33"}/>
      <ButtonUI 
        text="Tropical" 
        onClick={Button2}
        background = {button2state ? "#367A17" : "#FFFFFF33"}/>
      <ButtonUI 
        text="Arid" 
        onClick={Button3}
        background = {button3state ? "#367A17" : "#FFFFFF33"}/>
