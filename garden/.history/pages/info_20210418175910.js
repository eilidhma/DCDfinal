        ...
        <div className="info" >
          ...
          {mainstate === 0 && <MainImg src="couple.png" width="30%"/>}
            <div className="ButtonCont">
              <div data-aos="fade-in" data-aos-duration="4000"><ButtonUI text="Sustainability" onClick={Sust}/></div>
              <div data-aos="fade-in" data-aos-duration="4000"><ButtonUI text="Wellness Benefits" onClick={Well}/></div>
              <div data-aos="fade-in" data-aos-duration="4000"><ButtonUI text="Saving the Bees" onClick={Bees} data-aos="fade-in" data-aos-duration="4000"/></div>
            </div>
