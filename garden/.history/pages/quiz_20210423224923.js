...
export default function Quiz(){
  ...
  return (
    <div>
      {quizstate === true && <div className="quiz">
        <StatusBar percent={percent} width={width}/>
        <NameInput />
        <MainButton id="input" text="Let's Start!" onClick={() => console.log(document.getElementById("input").innerHTML)}/>
      ...
      {loadingstate === true && <div className="loading">
          <StatusBar percent="100%" width="100"/>
          <MedTitles text="Calculating your results..."/>
          <Loading />
        </div>}

      {resultsstate === true && <div className="results">
        <Logo/>
