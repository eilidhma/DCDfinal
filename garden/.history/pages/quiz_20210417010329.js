...
export default function Quiz() {
  ...
  const HandleChange = () =>{
    ...
    if(question === questions.first.Q){
      ...
      if(buttonstate === 1){
        window.localStorage('climate','temperate')
      }
      if(buttonstate === 2){
        window.localStorage('climate','tropical')
      }
      if(buttonstate === 3){
        window.localStorage('climate','arid')
      }
    ...
    if(question === questions.fourth.Q){
      ...
      if(buttonstate === 2){
        window.localStorage('Category','Flowers/Houseplants')
      }
