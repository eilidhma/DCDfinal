  ...
  return (
        ...
        <div className="info" >
          ...
          <div className="infoContent">
            ...
            <ButtonUI text="Sustainability" routeTo="/info" onClick={setMainState(1)}/>
            <ButtonUI text="Wellness Benefits" routeTo="/quiz" onClick={setMainState(2)}/>
            <ButtonUI text="Saving the Bees" routeTo="/quiz" onClick={setMainState(3)}/>
          </div>
