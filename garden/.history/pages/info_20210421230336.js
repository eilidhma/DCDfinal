...
const Info = () => {
  ...
  return (
        ...
        <div className="info" >
          ...
          <div data-aos="flip-up"><SmallDescription text="Gardening can help reduce symptoms of depression and anxiety. It gives you a chance to focus on something and put your mind to work with a goal and a task in mind"/>
