      ...
      <body>
        <div className="info" >
          ...
          <div className="infoContent">
            ...
            <Description text="Gardening reduces stress"/>
            <SmallDescription text="Gardening can help reduce symptoms of depression and anxiety. Gardening gives you a chance to focus on something and put your mind to work with a goal and a task in mind"/>
          </div>
          {/* END OF WELLNESS */}
