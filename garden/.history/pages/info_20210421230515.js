...
const Info = () => {
  ...
  return (
        ...
        <div className="info" >
          ...
          <div data-aos="zoom-in"><SmallDescription text="When you take the time to prepare, plant, weed, water, and harvest your own garden, you are getting sunshine, fresh air, and physical activity. All that digging, planting and weeding burns calories and strengthens your heart."/>
          </div>}
          {/* END OF WELLNESS */}
