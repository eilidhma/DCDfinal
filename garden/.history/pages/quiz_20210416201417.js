    ...
    <div className="quiz">
      ...
      <div className="questionCont">
        <QuestionButton 
          ...
          borderColor = {borderstate === 1 ? "2px solid #367A17" : "2px solid #FFFFFF"}/>
        <QuestionButton 
          text={button2} 
          onClick={()=>setButtonState(2)}
          background = {buttonstate === 2 ? "#367A17" : "#FFFFFF33"}
          borderColor = {borderstate === 2 ? "2px solid #367A17" : "2px solid #FFFFFF"}/>
        <QuestionButton 
          text={button3} 
          onClick={()=>setButtonState(3)}
          background = {buttonstate === 3 ? "#367A17" : "#FFFFFF33"}
          borderColor = {borderstate === 3 ? "2px solid #367A17" : "2px solid #FFFFFF"}/>
      </div>
